...
internal static class ValidationHelper
{
    ...
    internal static bool TryGetMemberInfo<T>(this Expression body, [NotNullWhen(true)] out T? memberInfo)
        where T : MemberInfo
    {
    ...
    internal static bool TryGetWritablePropertyInfo(this Expression body, [NotNullWhen(true)] out PropertyInfo? propInfo)
    {
