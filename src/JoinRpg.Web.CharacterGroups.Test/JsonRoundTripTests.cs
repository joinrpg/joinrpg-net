...
public class JsonRoundTripTests
{
    ...
    {
        var instance = new ProjectRoleGridGroupHeaderRowViewModel(new CharacterGroupLinkSlimViewModel(new CharacterGroupIdentification(1, 1), "GroupName", IsPublic: false, IsActive: false), "<p>Описание группы</p>");
