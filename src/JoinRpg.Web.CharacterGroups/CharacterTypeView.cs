...
internal enum CharacterTypeView
{
    ...
    NonPlayer,
    [Display(Name = "Шаблон персонажей", Description = "Это прописанный мастерами шаблон, на который можно принять несколько заявок, каждая из которых станет полноценным персонажем.")]
    Slot,
}
