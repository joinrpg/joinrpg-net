...
public class ProgramItemInfoApi
{
    ...
    /// </summary>
    public required IEnumerable<AuthorInfoApi> Authors { get; set; }
    /// <summary>
    ...
    /// </summary>
    public required IEnumerable<RoomInfoApi> Rooms { get; set; }
    ...
    /// </summary>
    public required Uri ProgramItemDetailsUri { get; set; }
}
