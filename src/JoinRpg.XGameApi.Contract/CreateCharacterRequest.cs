...
public class CreateCharacterRequest
{
    ...
    /// <summary>
    /// Максимальное количество заявок на шаблон (только для типа Slot; null — без ограничений)
    /// </summary>
    public int? SlotLimit { get; set; }

    /// <summary>
    /// Название шаблона (только для типа Slot)
    /// </summary>
...
{
    /// <summary>
    /// Персонаж для игрока — заявки принимаются
    /// </summary>
    Player,

    /// <summary>
    /// Внеигровой персонаж (NPC) — заявки не принимаются
    /// </summary>
    NonPlayer,

    /// <summary>
    /// Шаблон — персонаж-шаблон, допускающий несколько заявок
    /// </summary>
    Slot,
}
