...
public class FatalReasonFilteringTest
{
    ...
    public void FatalReasonHidesOtherReasons()
    {
        ...
        Mock.Character.ValidateIfCanAddClaim(Mock, Mock.PlayerInfo, Mock.ProjectInfo, ClaimOperation.AddByPlayer).Kinds()
        ...
        Mock.Character.ValidateIfCanAddClaim(Mock, Mock.PlayerInfo, closedProject, ClaimOperation.AddByPlayer).Kinds()
    ...
    public void ArchivedProjectHidesOtherReasons()
    {
        ...
        Mock.Character.ValidateIfCanAddClaim(Mock, Mock.PlayerInfo, archived, ClaimOperation.AddByPlayer).Kinds()
