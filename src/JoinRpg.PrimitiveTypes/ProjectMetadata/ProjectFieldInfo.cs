    ...
    : IProjectEntityWithId
{
    ...
    public bool HasViewAccess(AccessArguments accessArguments)
    {
        return ProjectFieldVisibility switch
        {
            ...
            ProjectFieldVisibility.PlayerAndMaster when BoundTo == FieldBoundTo.Character => accessArguments.PlayerAccessToCharacter,
            ProjectFieldVisibility.PlayerAndMaster when BoundTo == FieldBoundTo.Claim => accessArguments.PlayerAccesToClaim,
