...
";
            ...
            var sendTasks = email.Recipients
                .Where(recipient => !recipient.ProjectAcls.Any())
                .Select(emailRecipient => MessageService.SendEmail($"{email.ProjectName}: приглашения к проживанию",
