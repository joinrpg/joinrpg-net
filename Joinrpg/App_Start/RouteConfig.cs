  ...
  public static class RouteConfig
  {
    public static void RegisterRoutes(RouteCollection routes)
    {
      ...
      routes.MapRoute(name: "ProjectFieldsCreate", url: "{ProjectId}/fields/create",
       ...
       routes.MapRoute(name: "ProjectFieldsArchive", url: "{ProjectId}/fields/archive",
        defaults: new
        {
            controller = "GameField",
            action = "DeletedList",
     ...
     routes.MapRoute(name: "ProjectFieldsSettings", url: "{ProjectId}/fields/settings",
        defaults: new
        {
            controller = "GameField",
            action = "Settings",
      ...
      routes.MapRoute(name: "FinanceExport", url: "{ProjectId}/money.csv/{action}/{token}",
        ...
        routes.MapRoute(name: "FinanceByMaster", url: "{ProjectId}/money/bymaster/{masterId}",
            defaults: new { controller = "Finances", action = "ByMaster" });
