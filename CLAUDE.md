...
При исправлении бага **всегда рассматривать добавление юнит теста**, который воспроизводит баг до фикса и проходит после. Это предотвращает регрессии. Тест добавляется в `src/JoinRpg.Domain.Test/` (или соответствующий тестовый проект).
