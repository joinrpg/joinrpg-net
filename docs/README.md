...
- [Схема базы данных](db-schema.md) — все таблицы, колонки и связи в mermaid-диаграммах по доменам ([как обновлять](db-schema-regenerate.md))
...
- [Контроль ленивых загрузок](lazy-loads-baseline.md) — интеграционные тесты ловят N+1 автоматически, как читать и обновлять снапшот

### Конфигурация
- [Добавление нового окружения](how-to-add-new-env.md) — настройка сред разработки
- [Тестовые пользователи для локальной разработки](local-dev-test-users.md) — сидинг тестовых аккаунтов и проекта-песочницы, только для локальной БД
