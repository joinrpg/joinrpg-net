...
---
 ...
 - Есть проект JoinRpg.Common.WebComponents — содержит неинтерактивные компонентики, из которых в перспективе можно собрать «фреймворк» стандартных JoinRpg компонентов
...
---
Если это Partial без интерактива, необходимо содержимое его перенести в компонент JoinRpg.Common.WebComponents и заменить Partial вызовом статического рендеринга компонента.
