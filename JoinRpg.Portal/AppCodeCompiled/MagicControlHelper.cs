...
namespace JoinRpg.Web.Helpers
{
  ...
  public static class MagicControlHelper
  {
    ...
    public static IHtmlContent GetMagicSelect(int projectId, bool showCharacters, ShowImplicitGroups showGroups, MagicControlStrategy strategy, string propertyName, IEnumerable<string> elements, bool showSpecial)
    {
